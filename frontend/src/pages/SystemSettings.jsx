...
const SystemSettings = () => {
  ...
  const [branches, setBranches] = useState(() => {
    ...
    return savedData ? JSON.parse(savedData) : [
      { code: 'BR-DEL', name: 'Delhi Head Office', manager: 'Aarav Sharma', status: 'Active' },
  ...
  const [departments, setDepartments] = useState(() => {
    ...
    return savedData ? JSON.parse(savedData) : [
      ...
      { id: '4', name: 'Operations', head: 'Aarav Sharma', capacity: 120 },
            ...
            <div className="settings-group">
              ...
              <div className="table-responsive">
                <table className="settings-data-table font-small">
                  ...
                  <tbody>
                    {[
                      { time: 'Today, 10:30 AM', user: 'Aarav Sharma', action: 'Modified Overtime Multiplier to 1.5x', scope: 'Payroll Settings', status: 'Success' },
                      { time: 'Today, 09:15 AM', user: 'Aarav Sharma', action: 'Authorized Twilio SMS Gateway URL', scope: 'SMS Config', status: 'Success' },
                      ...
                      { time: '03-Jun-2026, 11:00 AM', user: 'Aarav Sharma', action: 'Added New Branch (Jaipur Operations)', scope: 'Branch Config', status: 'Success' }
                    ].map((row, idx) => (
                      <tr key={idx}>
