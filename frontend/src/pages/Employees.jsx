            ...
            <div className="id-card-render-wrapper" ref={idCardRef}>
              <div className="id-card-front">
                ...
                <div className="id-card-logo-area">
                  ...
                  <div className="id-card-company-title">{idCardEmployee.companyName || generalSettings?.companyName || user?.companyName || 'Corporate Enterprise'}</div>
                  <div className="id-card-company-subtitle">{idCardEmployee.branch ? (idCardEmployee.branch.toLowerCase().includes('branch') ? idCardEmployee.branch : `${idCardEmployee.branch} Branch`) : (idCardEmployee.officeLocation || 'Main Headquarters')}</div>
                </div>
