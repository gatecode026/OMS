...
const ActivityLogs = () => {
  ...
  const [activeSessions, setActiveSessions] = useState([
    { id: 'SES-9421', employeeName: 'Aarav Sharma', ipAddress: '103.45.201.8', location: 'Delhi, India', device: 'desktop', browser: 'Chrome', loginTime: '2026-06-04 10:15', mfa: 'Verified', status: 'active' },
  ...
  const [configChanges, setConfigChanges] = useState([
    { id: 'CCN-001', operator: 'Aarav Sharma', key: 'central_mfa_policy', prev: 'MFA_OPTIONAL', next: 'MFA_MANDATORY_ALL', scope: 'Security', timestamp: '2026-06-03 14:20' },
    { id: 'CCN-002', operator: 'Neha Verma', key: 'payroll_disbursement_day', prev: '28th', next: '30th', scope: 'Payroll', timestamp: '2026-06-02 09:15' },
    { id: 'CCN-003', operator: 'Aarav Sharma', key: 'max_daily_login_attempts', prev: '5 Attempts', next: '3 Attempts', scope: 'Security', timestamp: '2026-05-30 17:50' },
  ...
  const [adminOps, setAdminOps] = useState([
    { id: 'AOP-001', operator: 'Aarav Sharma', action: 'Trigger Production DB Backup', target: 'Postgres DB Cluster', managerSig: 'Verified', auditorSig: 'Verified', status: 'Executed', timestamp: '2026-06-04 03:00' },
    ...
    { id: 'AOP-003', operator: 'Aarav Sharma', action: 'Purged 180-Day System Logs', target: 'Syslog Indexes', managerSig: 'Verified', auditorSig: 'Verified', status: 'Executed', timestamp: '2026-06-01 10:00' },
