...
const EmployeeProfile = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/api/v1/employees/${empId}`, {
      headers: {
            ...
            <div className="id-card-render-wrapper" ref={idCardRef}>
              <div className="id-card-front">
                ...
                <div className="id-card-logo-area">
                  ...
                  <div className="id-card-company-title">{emp.companyName || 'GATECODE TECHNOLOGIES'}</div>
              ...
              <div className="id-card-back">
                <div className="id-card-back-bullets">
                  <div className="id-card-bullet-row"><span className="id-bullet-dot"></span><p>This card is the official property of {emp.companyName || 'Gatecode Technologies'} and must be returned on demand.</p></div>
