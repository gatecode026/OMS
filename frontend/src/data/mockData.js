...
export const mockDailyReports = [
  {
    ...
    priorityTasksTomorrow: 'High',
    attachments: ['rbac_schema_v3.pdf'],
    status: 'Approved',
    submittedTime: '2026-06-03T18:30:00',
    productivityScore: 94,
    feedback: 'Excellent work structuring the RBAC core module.',
    approvalHistory: [
      { role: 'Employee', user: 'Ananya Gupta', action: 'Submitted', timestamp: '2026-06-03T18:30:00', comments: '' },
  ...
  },
  {
    ...
    feedback: '',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-06-03T18:00:00', comments: '' }
    ]
  },
  {
    id: 'REP-003',
    ...
    approvalHistory: [
      { role: 'Employee', user: 'Suresh Kumar', action: 'Submitted', timestamp: '2026-06-03T17:15:00', comments: '' },
  ...
  },
  {
    ...
    approvalHistory: [
      { role: 'Employee', user: 'Neha Verma', action: 'Submitted', timestamp: '2026-06-02T18:45:00', comments: '' },
  ...
  },
  {
    ...
    approvalHistory: [
      { role: 'Employee', user: 'Deepak Joshi', action: 'Submitted', timestamp: '2026-06-02T15:00:00', comments: '' },
  ...
  // Arjun Mehta Historic Reports (to get exactly 5 approved, 1 rejected, 1 pending)
  {
    id: 'REP-006',
    employeeName: 'Arjun Mehta',
    employeeId: 'EMP-2026-006',
    ...
    tasksCompleted: 4,
    pendingTasksCount: 0,
    summary: 'Wrote API integrations for the task management boards.',
    ongoingTasks: 'Testing context callbacks.',
    pendingTasks: 'None.',
    majorAccomplishments: 'Tasks route fully works.',
    ...
    workingHours: 8.5,
    overtimeHours: 0.5,
    plannedTasksTomorrow: 'Review with team leader.',
    expectedDeliverablesTomorrow: 'Pull request approved.',
    priorityTasksTomorrow: 'High',
    attachments: [],
    status: 'Approved',
    submittedTime: '2026-06-02T17:45:00',
    productivityScore: 100,
    feedback: 'Great job!',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-06-02T17:45:00', comments: '' },
      { role: 'Team Leader', user: 'Ananya Gupta', action: 'Approved', timestamp: '2026-06-02T18:30:00', comments: 'Verified.' }
    ]
  },
  {
    id: 'REP-007',
    ...
    tasksCompleted: 5,
    pendingTasksCount: 0,
    summary: 'Refactored context state variables to avoid unnecessary re-renders.',
    ongoingTasks: 'Optimizing list layouts.',
    pendingTasks: 'None.',
    majorAccomplishments: 'Renders reduced by 40%.',
    challengesFaced: 'None.',
    supportRequired: 'None.',
    loginTime: '09:02 AM',
    logoutTime: '05:02 PM',
    workingHours: 8.0,
    overtimeHours: 0.0,
    plannedTasksTomorrow: 'Work on tasks widget.',
    expectedDeliverablesTomorrow: 'Tasks list items styled.',
    priorityTasksTomorrow: 'Medium',
    attachments: [],
    status: 'Approved',
    submittedTime: '2026-06-01T17:15:00',
    productivityScore: 100,
    feedback: 'Excellent optimization.',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-06-01T17:15:00', comments: '' },
      { role: 'Team Leader', user: 'Ananya Gupta', action: 'Approved', timestamp: '2026-06-01T18:00:00', comments: 'Looks clean.' }
    ]
  },
  {
    id: 'REP-008',
    ...
    tasksCompleted: 3,
    pendingTasksCount: 0,
    summary: 'Added seed data structures for projects and teams.',
    ongoingTasks: 'Reviewing employee records.',
    pendingTasks: 'None.',
    majorAccomplishments: 'Data populations completed.',
    challengesFaced: 'None.',
    supportRequired: 'None.',
    loginTime: '08:58 AM',
    logoutTime: '05:10 PM',
    workingHours: 8.2,
    overtimeHours: 0.2,
    plannedTasksTomorrow: 'Begin refactoring context API.',
    expectedDeliverablesTomorrow: 'Context wrapper updated.',
    priorityTasksTomorrow: 'Low',
    attachments: [],
    status: 'Approved',
    submittedTime: '2026-05-31T17:30:00',
    productivityScore: 100,
    feedback: 'Solid work.',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-05-31T17:30:00', comments: '' },
      { role: 'Team Leader', user: 'Ananya Gupta', action: 'Approved', timestamp: '2026-05-31T18:00:00', comments: 'Good job.' }
    ]
  },
  {
    id: 'REP-009',
    ...
    tasksCompleted: 1,
    pendingTasksCount: 3,
    summary: 'Spent day researching Recharts tooltip bugs. No progress on direct tasks.',
    ongoingTasks: 'Debugging SVG viewport clipping.',
    pendingTasks: 'Tooltip styling fixes.',
    majorAccomplishments: 'Found the root cause in absolute layouts.',
    challengesFaced: 'SVG clipping issues on mobile.',
    supportRequired: 'None.',
    loginTime: '09:30 AM',
    logoutTime: '02:00 PM',
    workingHours: 4.5,
    overtimeHours: 0.0,
    plannedTasksTomorrow: 'Implement custom tooltip wrapper.',
    expectedDeliverablesTomorrow: 'Custom tooltip component.',
    priorityTasksTomorrow: 'High',
    attachments: [],
    status: 'Rejected',
    submittedTime: '2026-05-30T14:15:00',
    productivityScore: 25,
    feedback: 'Please complete the assigned task logs and work full shift hours.',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-05-30T14:15:00', comments: '' },
      { role: 'Team Leader', user: 'Ananya Gupta', action: 'Rejected', timestamp: '2026-05-30T16:00:00', comments: 'Report rejected. Work hours below minimum and tasks incomplete.' }
    ]
  },
  {
    id: 'REP-010',
    ...
    tasksCompleted: 3,
    pendingTasksCount: 0,
    summary: 'Set up Vite packaging configuration for staging builds.',
    ongoingTasks: 'Analyzing bundle sizes.',
    pendingTasks: 'None.',
    majorAccomplishments: 'Production bundle builds successfully.',
    challengesFaced: 'None.',
    supportRequired: 'None.',
    loginTime: '09:00 AM',
    logoutTime: '05:00 PM',
    workingHours: 8.0,
    overtimeHours: 0.0,
    plannedTasksTomorrow: 'Configure environment variable scopes.',
    expectedDeliverablesTomorrow: 'Prod settings verified.',
    priorityTasksTomorrow: 'Medium',
    attachments: [],
    status: 'Approved',
    submittedTime: '2026-05-29T17:05:00',
    productivityScore: 100,
    feedback: 'Staging configuration verified.',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-05-29T17:05:00', comments: '' },
      { role: 'Team Leader', user: 'Ananya Gupta', action: 'Approved', timestamp: '2026-05-29T18:00:00', comments: 'Build works fine.' }
    ]
  },
  {
    id: 'REP-011',
    ...
    tasksCompleted: 5,
    pendingTasksCount: 0,
    summary: 'Created first version of dashboard layout structures.',
    ongoingTasks: 'Styling adjustments.',
    pendingTasks: 'None.',
    majorAccomplishments: 'Grid layout works on all breakpoints.',
    challengesFaced: 'None.',
    supportRequired: 'None.',
    loginTime: '08:45 AM',
    logoutTime: '05:45 PM',
    workingHours: 9.0,
    overtimeHours: 1.0,
    plannedTasksTomorrow: 'Add basic widgets placeholders.',
    expectedDeliverablesTomorrow: 'Visual outline completed.',
    priorityTasksTomorrow: 'Medium',
    attachments: [],
    status: 'Approved',
    submittedTime: '2026-05-28T17:50:00',
    productivityScore: 100,
    feedback: 'Approved.',
    approvalHistory: [
      { role: 'Employee', user: 'Arjun Mehta', action: 'Submitted', timestamp: '2026-05-28T17:50:00', comments: '' },
      { role: 'Team Leader', user: 'Ananya Gupta', action: 'Approved', timestamp: '2026-05-28T18:30:00', comments: 'Approved.' }
    ]
  }
];
